...
def leer_coordenadas(path: str):
    """Lee un fichero con coordenadas y devuelve una lista de tuplas"""
...
if __name__ == "__main__":
    ...
    coordenadas_a_distancias(
        "Viajante/Datos/10_coordenadas.txt", "Viajante/Datos/10_distancias.txt"
    )
